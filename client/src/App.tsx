...
export const App = () => {
  ...
  const [notFoundCode] = useState(() => new URLSearchParams(window.location.search).get('notFound'))
    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-8">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>Paste a long URL and get a short link.</CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col gap-4">
          {notFoundCode && (
            <p className="rounded-md border border-destructive/40 p-2 text-destructive text-sm">
