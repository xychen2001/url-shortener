        ...
        >
          <CardContent className="px-5 py-5">
            {!shortUrl ? (
              ...
              >
                {notFoundCode && (
                  <p className="rounded-md border border-destructive/25 bg-destructive/[0.04] px-3 py-2 text-destructive text-sm">
                    Short URL{" "}
                    <span className="font-medium">"{notFoundCode}"</span> was
                    not found.
                  </p>
                )}
